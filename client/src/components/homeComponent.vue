                            ...
                            <div class="card-block">
                                <div class="dropdown float-right" v-if="blog.author._id === myId._id">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item nav-link" href="#" @click.prevent="editBlog(blog._id)">Edit blog</a>
                                    <a class="dropdown-item nav-link" href="#" @click.prevent="deleteBlog(blog._id)">Delete blog</a>
                                  </div>
                                </div>
