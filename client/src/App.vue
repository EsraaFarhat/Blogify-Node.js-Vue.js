...
<nav class="navbar navbar-expand-lg">
  <img src="./assets/animal-1299357_1280.png" style="width:50px; height:50px;">
  ...
  <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
    ...
    <li v-if="data" class="nav-item dropdown">
        ...
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img src="./assets/female.svg" style="width:40px; height:40px;" class="mr-2" v-if="gender == 'female'">
          <img src="./assets/male.svg" style="width:40px; height:40px;" class="mr-2" v-if="gender == 'male'">
          {{fname}} {{lname}}
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <router-link class="text-secondary ml-3 nav-dropdown-link" to='/profile/me' @click="profile">My profile </router-link>
          <div class="dropdown-divider"></div>
            <router-link class="text-secondary ml-3 nav-dropdown-link" to='/login' @click="logout">Logout</router-link>
        </div>
      </li>
    </ul>
  </div>
